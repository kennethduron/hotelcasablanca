  ...
  return (
    <main className="grid min-h-[70vh] place-items-center px-6 py-16">
      <section className="max-w-2xl rounded-[8px] border border-hotel-line bg-hotel-ivory p-8 text-center shadow-hotel-card">
        ...
        <h1 className="hotel-serif mt-3 text-5xl font-bold text-hotel-forest">Gracias por contactarnos</h1>
        <p className="mt-4 leading-8 text-hotel-muted">Tu solicitud quedó como pendiente de revisión. El equipo de Hotel Casa Blanca revisará disponibilidad y te contactará con el siguiente paso.</p>
