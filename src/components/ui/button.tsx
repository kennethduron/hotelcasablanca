...
const variants: Record<ButtonVariant, string> = {
  ...
  outlineDark: "border border-hotel-forest bg-hotel-ivory text-hotel-forest hover:bg-hotel-forest hover:text-white focus-visible:ring-hotel-forest",
...
const base =
  "inline-flex min-h-12 cursor-pointer items-center justify-center gap-2 rounded-[6px] px-5 py-3 text-center text-sm font-bold uppercase leading-none transition duration-200 active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-70";
