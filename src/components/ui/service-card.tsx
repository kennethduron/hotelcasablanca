...
export function ServiceCard({ service }: { service: Service }) {
  ...
  return (
    <article className="overflow-hidden rounded-[8px] border border-hotel-line bg-hotel-ivory shadow-hotel-card" id={service.id}>
      ...
      <div className="relative p-5">
        ...
        <Link className="mt-4 inline-flex items-center gap-2 text-sm font-semibold text-hotel-gold-700" href={`/servicios#${service.id}`}>
